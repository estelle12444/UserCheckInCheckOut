            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="row mb-3">
                            <label for="matricule" class="col-md-4 col-form-label text-md-end">{{ __('Quicklook') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4  text-md-end">{{ __('Nom et prénom') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="department" class="col-md-4 col-form-label text-md-end">{{ __('Département') }}</label>

                            <div class="col-md-8">

                              <select id="siteSelect" style="color: #000000 !important"
